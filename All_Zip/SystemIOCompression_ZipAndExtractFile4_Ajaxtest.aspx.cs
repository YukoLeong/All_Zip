...
public partial class SystemIOCompression_ZipAndExtractFile4_Ajaxtest : System.Web.UI.Page
{
    ...
    protected void LoadButton_Click(object sender, EventArgs e)
    {
        ...
        //using (var archive = ZipFile.Open(@"C:\Users\kanon\Desktop\EXLSTSE.zip", ZipArchiveMode.Update))      // 絕對路徑
        {
            ...
            ScriptManager.RegisterStartupScript(this, GetType(), "call", script, true);



            //ScriptManager.GetCurrent(Page).SetFocus(LoadButton);
            //Page.SetFocus(LoadButton);
